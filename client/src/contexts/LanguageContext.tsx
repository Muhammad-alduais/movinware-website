...
const translations = {
  en: {
    ...
    'industries.manufacturing.timeline': '',
    ...
    'contact.form.message_sent': 'Message Sent!',
    'contact.form.message_placeholder': 'Tell us about your project...',
    'contact.form.success_title': 'Message delivered successfully!',
    'contact.form.success_description': 'We have received your message and will get back to you within 24 hours.',
    'contact.form.try_again': 'Try Again',
    'contact.form.error_title': 'Failed to send message',
    'contact.form.error_description': 'Please try again or contact us directly at',
    'contact.form.error.name': 'Please enter your full name',
    'contact.form.error.email': 'Please enter your email address',
    'contact.form.error.email_invalid': 'Please enter a valid email address',
    'contact.form.error.message': 'Please enter your message',
    'contact.form.toast_success': 'Message sent successfully!',
    'contact.form.toast_success_desc': 'We\'ll get back to you within 24 hours.',
    'contact.form.toast_mailto': 'Opening your email client...',
    'contact.form.toast_mailto_desc_emailjs_fail': 'EmailJS failed, using your default email client instead.',
    'contact.form.toast_mailto_desc_not_configured': 'Please send the email from your email client to complete the process.',
    'contact.form.toast_error': 'Failed to send message',
    'contact.form.toast_error_desc': 'Please try again or contact us directly at info@movinware.com',
    ...
    'footer.copyright': '© 2026 MovinWare. All rights reserved.',
  ...
  ar: {
    ...
    'erp.accounting.fullDescription': 'نظام متكامل لإدارة الشؤون المالية وإعداد التقارير مع رؤى في الوقت الفعلي وعمليات آلية للسيطرة الشاملة على الأعمال. توفر مجموعة المحاسبة الخاصة بنا رؤية كاملة لعملياتك المالية مع سير عمل آلي وتقارير ذكية وتكامل سلس مع أنظمة المصرفية والدفع.',
    ...
    'erp.hr.fullDescription': 'نظام متكامل لإدارة الموارد البشرية الذي يغطي دورة حياة الموظف بأكملها من التوظيف إلى التقاعد مع تحليلات متقدمة. تحول مجموعة الموارد البشرية الخاصة بنا إدارة الأشخاص بسير عمل آلي وقدرات الخدمة الذاتية ورؤى قائمة على البيانات تساعدك في جذب واستبقاء وتطوير المواهب العليا.',
    ...
    'erp.manufacturing.fullDescription': 'حل متكامل لإدارة الإنتاج الذي يحسن عمليات التصنيع ومراقبة الجودة مع المراقبة في الوقت الفعلي. تمكن وحدة التصنيع الخاصة بنا التحول الرقمي مع تكامل إنترنت الأشياء وسير العمل الآلي وتتبع الإنتاج في الوقت الفعلي الذي يزيد من الكفاءة ويضمن الجودة المتسقة.',
    ...
    'contact.form.message_sent': 'تم إرسال الرسالة!',
    ...
    'contact.form.try_again': 'حاول مرة أخرى',
    'contact.form.error_title': 'فشل إرسال الرسالة',
    'contact.form.error_description': 'يرجى المحاولة مرة أخرى أو الاتصال بنا مباشرة على',
    'contact.form.error.name': 'يرجى إدخال اسمك الكامل',
    ...
    'contact.form.toast_success_desc': 'سنتواصل معك خلال 24 ساعة.',
    'contact.form.toast_mailto': 'جاري فتح تطبيق البريد...',
    'contact.form.toast_mailto_desc_emailjs_fail': 'فشل EmailJS، سيتم استخدام تطبيق البريد الافتراضي بدلاً منه.',
    'contact.form.toast_mailto_desc_not_configured': 'يرجى إرسال البريد من تطبيق البريد الخاص بك لإكمال العملية.',
    'contact.form.toast_error': 'فشل إرسال الرسالة',
    'contact.form.toast_error_desc': 'يرجى المحاولة مرة أخرى أو الاتصال بنا مباشرة على info@movinware.com',
    ...
    'features.integration_full_description': 'اتصال سلس مع أدواتك وأنظمتك الحالية، مما يضمن تدفق البيانات بسلاسة عبر مجموعة التكنولوجيا الكاملة دون انقطاع. يدعم مركز التكامل لدينا كلاً من واجهات برمجة التطبيقات الحديثة والأنظمة القديمة، مما يوفر نظاماً موحداً للبيانات يلغي حواجز البيانات ويمكّن ذكاء الأعمال الشامل.',
    ...
    'footer.copyright': '© 2026 MovinWare. جميع الحقوق محفوظة.',
    'footer.built_by': 'تم تطويره بالكامل بواسطة م. محمد امين الدعيس',
