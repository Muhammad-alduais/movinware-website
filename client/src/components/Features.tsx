      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            {t('features.title')} <br className="hidden sm:block" />{t('features.title_highlight')}
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <FeatureCard
            ...
            title={t('features.natural_interaction.title')}
            description={t('features.natural_interaction.description')}
            index={1}
          />
          <FeatureCard
            ...
            title={t('features.precise_movement.title')}
            description={t('features.precise_movement.description')}
            index={2}
          />
          <FeatureCard
            ...
            title={t('features.spatial_awareness.title')}
            description={t('features.spatial_awareness.description')}
            index={3}
          />
          <FeatureCard
            ...
            title={t('features.enhanced_security.title')}
            description={t('features.enhanced_security.description')}
            index={4}
          />
          <FeatureCard
            ...
            title={t('features.task_assistance.title')}
            description={t('features.task_assistance.description')}
            index={5}
          />
        </div>
      </div>
