    ...
    <header className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20 gap-4">
          ...
          <a 
            href="#" 
            className="flex items-center space-x-2 lg:space-x-3 rtl:space-x-reverse hover:opacity-80 transition-all duration-300 hover:scale-105 flex-shrink-0"
            onClick={(e) => {
              e.preventDefault();
              scrollToTop();
            }} 
          ...
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-pulse-500 flex-shrink-0">
            ...
            <div className={`text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 ${language === 'ar' ? 'font-arabic' : 'font-brockmann'} drop-shadow-sm`}>
              MovinWare
            </div>
          </a>
