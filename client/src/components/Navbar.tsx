    ...
    <header className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20 gap-4">
          ...
          <a 
            href="#" 
            className="flex items-end gap-2 lg:gap-3 hover:opacity-80 transition-all duration-300 hover:scale-105 flex-shrink-0"
            onClick={(e) => {
              e.preventDefault();
              scrollToTop();
            }} 
          ...
          >
            ...
            <div className="text-lg sm:text-xl lg:text-2xl font-bold font-glacial text-gray-900 drop-shadow-sm leading-none">
              MovinWare
            </div>
          </a>
