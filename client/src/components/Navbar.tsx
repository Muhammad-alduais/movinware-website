      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20 gap-4">
          ...
          <a 
            ...
            dir="ltr"
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-pulse-500 flex-shrink-0 flex items-end">
            ...
            <span className="text-lg sm:text-xl lg:text-2xl font-bold font-glacial text-gray-900 drop-shadow-sm leading-none">
              MovinWare
            </span>
          </a>
